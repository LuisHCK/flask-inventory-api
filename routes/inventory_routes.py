...
from controllers.inventories_controller import index, create, show, update, destroy, list_inventory_products, create_inventory_product, update_inventory_product
...
router.route('/<inventory_id>/products/<product_id>', methods=['PATCH'])(update_inventory_product)
